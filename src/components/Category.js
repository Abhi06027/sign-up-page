const Category = () => {
    return ( 
      ...
      <img className=" w-28 mx-10  mt-10   "  src=" ./images/li.png" alt=""/>
      
      
      
      <div className=" flex justify-center  items-center   md:mt-44 lg:mt-44  "  >  
        ...
        <div className="   py-2" >  
         <div className="  text-blue-800 hover:bg-blue-300 rounded-full w-36  hover:underline py-1  text-center   "  >   Forgot password?        </div>
          ...
          <div className=" mt-3 mb-3   bg-white rounded-full text-center border-gray-400  hover:border-black  border-2  flex  items-center  hover:bg-gray-100 text-black py-3 "   >   
         
          <img className=" w-6 mx-2 ml-16   "  src=" ./images/apple.png" alt=""/>
